...
//define('TEXT_PRODUCT_FREE_SHIPPING_ICON', '配送料無料'); // for text or set to '' for nothing
define('TEXT_PRODUCT_FREE_SHIPPING_ICON', zen_image(DIR_WS_TEMPLATE_IMAGES . 'always-free-shipping.gif', '配送料無料')); // for an image or comment out to use another
?>