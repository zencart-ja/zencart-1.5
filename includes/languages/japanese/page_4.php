...
define('NAVBAR_TITLE', 'ページ4');
define('HEADING_TITLE', 'ページ4');

define('TEXT_INFORMATION', 'この部分を変更するには、<br /><strong>/includes/languages/japanese/page_4.php</strong>の<strong>define(\'TEXT_INFORMATION\',</strong>の右側の<br />
